...
public class DiscountCalculator {
    ...
    public static void main(String[] args) {
        ...
        while (finished == false) {
            // Prompt user to enter price of an item
            ...
            System.out.print("Please enter the discount percentage to be applied (ex: 20 for a 20% discount): ");
            ...
            System.out.format("The total price before discount applied is: $%.2f.\n", total);
        ...
        System.out.println("Thank you for using the Discount Calculator! Come back soon!");
