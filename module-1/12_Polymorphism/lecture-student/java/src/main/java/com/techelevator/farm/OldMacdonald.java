...
public class OldMacdonald {
	public static void main(String[] args) {
		...
		Tractor tommy = new Tractor();

		Singable[] singables = new Singable[] { daisy, nugget, peru, tommy };
		...
		System.out.println("Or you can buy the whole farm for $" + total);

		List<String> myList = new ArrayList<>();

		//wants us to know this exists, but would NOT recommend doing it this way
		...
		if (eric instanceof Sellable) {
			System.out.println("You can sell Eric! :( ");
		}
