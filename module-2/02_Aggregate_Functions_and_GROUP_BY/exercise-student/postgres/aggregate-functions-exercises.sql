...
SELECT name, MIN(population) AS smallest_country_pop
FROM country
WHERE population != 0
GROUP BY name
...
SELECT name, population/surfacearea AS pop_dens
FROM country
...
SELECT name, population/surfacearea AS pop_dens, lifeexpectancy 
FROM country
