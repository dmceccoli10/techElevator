...
FROM payment
INNER JOIN customer ON payment.customer_id = customer.customer_id
--INNER JOIN ON rental.customer_ID = customer.customer_ID This gives me all of Rosemary's rentals, I don't want that
INNER JOIN rental ON rental.rental_id = payment.rental_id
WHERE payment_id = 16666;

-- What did they rent? Film id can be gotten through inventory.
SELECT payment.*, customer.first_name, customer.last_name, customer.customer_id, rental.return_date, film.film_id, film.title 
FROM payment
INNER JOIN customer ON payment.customer_id = customer.customer_id
INNER JOIN rental ON rental.rental_id = payment.rental_id
...
--Lets use a CTE to make this problem better 
