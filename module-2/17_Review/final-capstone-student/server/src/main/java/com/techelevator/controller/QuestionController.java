...
public class QuestionController {
    ...
    public List<Question> getAllQuestions (Principal p){
        System.out.println(p.getName()+" requested all of the questions.");
    ...
    public void updateQuestion (Principal p, @PathVariable int id){
        if (questionDAO.deleteQuestion(id))
            System.out.println(p.getName()+" successfully deleted "+id);//just print to console on server, not telling client
        else
