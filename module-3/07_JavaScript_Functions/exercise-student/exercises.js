 ...
 */
    function isAdmitted(gpa, satScore, recommendation) {
        if ((gpa > 4.0 || satScore > 1300) || (gpa > 3.0 || satScore > 1200) && recommendation == true) {
            return true;
        } else {
            return false;
        }
...
/**
 * @param {string[]} words
 * @returns {string[]} of words with happy prepended
 */
...
/**
 * 
 * @param {fullAddress[]} array containing street number, name type, city, state, address
 * @returns {string[]} array of full address
 */
...
/**
 * 
 * @param {element[]} input element array of numbers or strings
 * @returns {element} largest element in the array 
 */
